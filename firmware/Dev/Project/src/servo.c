...
/**
 * @brief Sirve para calibrar el angulo de movimiento de cada servo
 * 
 * @param pulsador in, Pulsador para parar en el momento que se requiera y dar por terminada la calibracion
 * @param grados in, indica los grados a mover
 * @param servo in, se debe escoger el servo a calibrar
 */
...
/**
 * @brief Entrega el puso maximo y minimo del servomotor escogidos
 * 
 * @param servo in, escoger servo0, servo1 o servo2
 * @param min_pulse out, entrega pulso minimo del servo escogido
 * @param max_pulse out, entrega pulso maximo del servo escogido
 */
...
/**
 * @brief Controla los servos de la tapa, se debe escoger la direccion del movimiento
 * 
 * @param dir in (enum), UP DOWN para servo lamina, LEFT RIGH para servo barra
 * @param servo in escoger servo0, servo1, servo2
 */
