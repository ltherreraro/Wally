 ...
 *
 * DTS input file:
 *   /home/tatiana/projects/zephyros-rp2040-example3/Project/build/zephyr/zephyr.dts.pre
 *
 * Directories with bindings:
 *   /home/tatiana/projects/zephyros-rp2040-example3/Project/dts/bindings, $ZEPHYR_BASE/dts/bindings
 *
 ...
 *   16  /cpus/cpu@1
 *   17  /leds
 *   18  /soc/gpio@40014000
 *   19  /leds/led_0
 *   20  /my_leds_node
 *   21  /my_leds_node/led_blue_node
 *   22  /my_leds_nodem
 *   23  /my_leds_nodem/echo1
 *   24  /my_leds_nodem/echo2
 *   25  /my_leds_nodem/echo3
 *   26  /my_leds_nodem/echo4
 *   27  /my_leds_nodem/trig1
 *   28  /my_leds_nodem/trig2
 *   29  /my_leds_nodem/trig3
 *   30  /my_leds_nodem/trig4
 *   31  /my_leds_nodes
 *   32  /my_leds_nodes/led_green_node
 *   33  /my_leds_nodes1
 *   34  /my_leds_nodes1/led_red_node
 *   35  /my_leds_nodes2
 *   36  /my_leds_nodes2/led_pink_node
 *   37  /pwm_leds
 *   38  /pwm_leds/pwm_led_0
 *   39  /pwm_leds1
 *   40  /pwm_leds1/pwm_led_1
 *   41  /pwm_leds1/pwm_led_3
 *   42  /soc/pin-controller@40014000/adc_default
 *   43  /soc/adc@4004c000
 *   44  /soc/pin-controller@40014000/i2c0_default
 *   45  /soc/i2c@40044000
 *   46  /soc/pin-controller@40014000/i2c1_default
 *   47  /soc/i2c@40048000
 *   48  /soc/memory@20000000
 *   49  /soc/peripheral-clk
 *   50  /soc/pin-controller@40014000/spi0_default
 *   51  /soc/spi@4003c000
 *   52  /soc/spi@40040000
 *   53  /soc/timer@e000e010
 *   54  /soc/pin-controller@40014000/uart0_default
 *   55  /soc/uart@40034000
 *   56  /soc/uart@40038000
 *   57  /soc/usbd@50100000
 *   58  /xtal-clk
 *   59  /soc/watchdog@40058000
 *   60  /soc/flash-controller@10000000
 *   61  /soc/flash-controller@10000000/flash@0
 *   62  /soc/flash-controller@10000000/flash@0/partitions
 *   63  /soc/flash-controller@10000000/flash@0/partitions/partition@0
 *   64  /soc/flash-controller@10000000/flash@0/partitions/partition@100
 *   65  /soc/pin-controller@40014000/adc_default/group1
 *   66  /soc/pin-controller@40014000/i2c0_default/group1
 *   67  /soc/pin-controller@40014000/i2c1_default/group1
 *   68  /soc/pin-controller@40014000/pwm_ch1b_default/group1
 *   69  /soc/pin-controller@40014000/pwm_ch4b_default
 *   70  /soc/pin-controller@40014000/pwm_ch4b_default/group1
 *   71  /soc/pin-controller@40014000/spi0_default/group1
 *   72  /soc/pin-controller@40014000/spi0_default/group2
 *   73  /soc/pin-controller@40014000/uart0_default/group1
 *   74  /soc/pin-controller@40014000/uart0_default/group2
 *
...
#define DT_N_FOREACH_CHILD(fn) fn(DT_N_S_chosen) fn(DT_N_S_aliases) fn(DT_N_S_soc) fn(DT_N_S_cpus) fn(DT_N_S_leds) fn(DT_N_S_xtal_clk) fn(DT_N_S_pwm_leds) fn(DT_N_S_my_leds_node) fn(DT_N_S_my_leds_nodes) fn(DT_N_S_my_leds_nodes1) fn(DT_N_S_my_leds_nodes2) fn(DT_N_S_pwm_leds1) fn(DT_N_S_servo1) fn(DT_N_S_servo0) fn(DT_N_S_servo2) fn(DT_N_S_servo3) fn(DT_N_S_my_leds_nodem)
#define DT_N_FOREACH_CHILD_SEP(fn, sep) fn(DT_N_S_chosen) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_aliases) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_soc) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_cpus) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_xtal_clk) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_pwm_leds) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_node) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodes) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodes1) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodes2) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_pwm_leds1) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_servo1) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_servo0) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_servo2) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_servo3) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem)
#define DT_N_FOREACH_CHILD_VARGS(fn, ...) fn(DT_N_S_chosen, __VA_ARGS__) fn(DT_N_S_aliases, __VA_ARGS__) fn(DT_N_S_soc, __VA_ARGS__) fn(DT_N_S_cpus, __VA_ARGS__) fn(DT_N_S_leds, __VA_ARGS__) fn(DT_N_S_xtal_clk, __VA_ARGS__) fn(DT_N_S_pwm_leds, __VA_ARGS__) fn(DT_N_S_my_leds_node, __VA_ARGS__) fn(DT_N_S_my_leds_nodes, __VA_ARGS__) fn(DT_N_S_my_leds_nodes1, __VA_ARGS__) fn(DT_N_S_my_leds_nodes2, __VA_ARGS__) fn(DT_N_S_pwm_leds1, __VA_ARGS__) fn(DT_N_S_servo1, __VA_ARGS__) fn(DT_N_S_servo0, __VA_ARGS__) fn(DT_N_S_servo2, __VA_ARGS__) fn(DT_N_S_servo3, __VA_ARGS__) fn(DT_N_S_my_leds_nodem, __VA_ARGS__)
#define DT_N_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) fn(DT_N_S_chosen, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_aliases, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_soc, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_cpus, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_xtal_clk, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_pwm_leds, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_node, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodes, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodes1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodes2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_pwm_leds1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_servo1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_servo0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_servo2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_servo3, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem, __VA_ARGS__)
#define DT_N_FOREACH_CHILD_STATUS_OKAY(fn) fn(DT_N_S_chosen) fn(DT_N_S_aliases) fn(DT_N_S_soc) fn(DT_N_S_cpus) fn(DT_N_S_leds) fn(DT_N_S_xtal_clk) fn(DT_N_S_pwm_leds) fn(DT_N_S_my_leds_node) fn(DT_N_S_my_leds_nodes) fn(DT_N_S_my_leds_nodes1) fn(DT_N_S_my_leds_nodes2) fn(DT_N_S_pwm_leds1) fn(DT_N_S_servo1) fn(DT_N_S_servo0) fn(DT_N_S_servo2) fn(DT_N_S_servo3) fn(DT_N_S_my_leds_nodem)
 ...
 *   /home/tatiana/projects/zephyros-rp2040-example3/Project/dts/bindings/pwm-servo.yaml
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's index in its parent's list of children: */
#define DT_N_S_servo0_CHILD_IDX 13
...
/* Node's index in its parent's list of children: */
#define DT_N_S_servo1_CHILD_IDX 12
...
/*
 * Devicetree node: /servo2
 *
 * Node identifier: DT_N_S_servo2
 *
 * Binding (compatible = pwm-servo):
 *   /home/tatiana/projects/zephyros-rp2040-example3/Project/dts/bindings/pwm-servo.yaml
 *
...
/* Node's full path: */
#define DT_N_S_servo2_PATH "/servo2"

/* Node's name with unit-address: */
#define DT_N_S_servo2_FULL_NAME "servo2"

/* Node parent (/) identifier: */
#define DT_N_S_servo2_PARENT DT_N

/* Node's index in its parent's list of children: */
#define DT_N_S_servo2_CHILD_IDX 14

/* Helper macros for child nodes of this node. */
#define DT_N_S_servo2_FOREACH_CHILD(fn) 
#define DT_N_S_servo2_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_servo2_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_servo2_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_servo2_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_servo2_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_servo2_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_servo2_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_servo2_ORD 12

/* Ordinals for what this node depends on directly: */
#define DT_N_S_servo2_REQUIRES_ORDS \
	0, /* / */ \
	9, /* /soc/pwm@40050000 */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_servo2_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_servo2_EXISTS 1
#define DT_N_INST_2_pwm_servo DT_N_S_servo2
#define DT_N_NODELABEL_servo2 DT_N_S_servo2

/* Macros for properties that are special in the specification: */
#define DT_N_S_servo2_REG_NUM 0
#define DT_N_S_servo2_RANGES_NUM 0
#define DT_N_S_servo2_FOREACH_RANGE(fn) 
#define DT_N_S_servo2_IRQ_NUM 0
#define DT_N_S_servo2_COMPAT_MATCHES_pwm_servo 1
#define DT_N_S_servo2_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_servo2_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_servo2_P_pwms_IDX_0_EXISTS 1
#define DT_N_S_servo2_P_pwms_IDX_0_PH DT_N_S_soc_S_pwm_40050000
#define DT_N_S_servo2_P_pwms_IDX_0_VAL_channel 2
#define DT_N_S_servo2_P_pwms_IDX_0_VAL_channel_EXISTS 1
#define DT_N_S_servo2_P_pwms_IDX_0_VAL_period 20000000
#define DT_N_S_servo2_P_pwms_IDX_0_VAL_period_EXISTS 1
#define DT_N_S_servo2_P_pwms_IDX_0_VAL_flags 0
#define DT_N_S_servo2_P_pwms_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_servo2_P_pwms_FOREACH_PROP_ELEM(fn) fn(DT_N_S_servo2, pwms, 0)
#define DT_N_S_servo2_P_pwms_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_servo2, pwms, 0)
#define DT_N_S_servo2_P_pwms_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_servo2, pwms, 0, __VA_ARGS__)
#define DT_N_S_servo2_P_pwms_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_servo2, pwms, 0, __VA_ARGS__)
#define DT_N_S_servo2_P_pwms_LEN 1
#define DT_N_S_servo2_P_pwms_EXISTS 1
#define DT_N_S_servo2_P_min_pulse 700000
#define DT_N_S_servo2_P_min_pulse_EXISTS 1
#define DT_N_S_servo2_P_max_pulse 2500000
#define DT_N_S_servo2_P_max_pulse_EXISTS 1
#define DT_N_S_servo2_P_compatible {"pwm-servo"}
#define DT_N_S_servo2_P_compatible_IDX_0 "pwm-servo"
#define DT_N_S_servo2_P_compatible_IDX_0_STRING_TOKEN pwm_servo
#define DT_N_S_servo2_P_compatible_IDX_0_STRING_UPPER_TOKEN PWM_SERVO
#define DT_N_S_servo2_P_compatible_IDX_0_EXISTS 1
#define DT_N_S_servo2_P_compatible_FOREACH_PROP_ELEM(fn) fn(DT_N_S_servo2, compatible, 0)
#define DT_N_S_servo2_P_compatible_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_servo2, compatible, 0)
#define DT_N_S_servo2_P_compatible_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_servo2, compatible, 0, __VA_ARGS__)
#define DT_N_S_servo2_P_compatible_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_servo2, compatible, 0, __VA_ARGS__)
#define DT_N_S_servo2_P_compatible_LEN 1
#define DT_N_S_servo2_P_compatible_EXISTS 1
#define DT_N_S_servo2_P_wakeup_source 0
#define DT_N_S_servo2_P_wakeup_source_EXISTS 1

/*
 * Devicetree node: /servo3
 *
 * Node identifier: DT_N_S_servo3
 *
 * Binding (compatible = pwm-servo):
 *   /home/tatiana/projects/zephyros-rp2040-example3/Project/dts/bindings/pwm-servo.yaml
 *
...
/* Node's full path: */
#define DT_N_S_servo3_PATH "/servo3"

/* Node's name with unit-address: */
#define DT_N_S_servo3_FULL_NAME "servo3"

/* Node parent (/) identifier: */
#define DT_N_S_servo3_PARENT DT_N

/* Node's index in its parent's list of children: */
#define DT_N_S_servo3_CHILD_IDX 15

/* Helper macros for child nodes of this node. */
#define DT_N_S_servo3_FOREACH_CHILD(fn) 
#define DT_N_S_servo3_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_servo3_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_servo3_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_servo3_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_servo3_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_servo3_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_servo3_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_servo3_ORD 13

/* Ordinals for what this node depends on directly: */
#define DT_N_S_servo3_REQUIRES_ORDS \
	0, /* / */ \
	9, /* /soc/pwm@40050000 */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_servo3_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_servo3_EXISTS 1
#define DT_N_INST_3_pwm_servo DT_N_S_servo3
#define DT_N_NODELABEL_servo3 DT_N_S_servo3

/* Macros for properties that are special in the specification: */
#define DT_N_S_servo3_REG_NUM 0
#define DT_N_S_servo3_RANGES_NUM 0
#define DT_N_S_servo3_FOREACH_RANGE(fn) 
#define DT_N_S_servo3_IRQ_NUM 0
#define DT_N_S_servo3_COMPAT_MATCHES_pwm_servo 1
#define DT_N_S_servo3_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_servo3_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_servo3_P_pwms_IDX_0_EXISTS 1
#define DT_N_S_servo3_P_pwms_IDX_0_PH DT_N_S_soc_S_pwm_40050000
#define DT_N_S_servo3_P_pwms_IDX_0_VAL_channel 3
#define DT_N_S_servo3_P_pwms_IDX_0_VAL_channel_EXISTS 1
#define DT_N_S_servo3_P_pwms_IDX_0_VAL_period 20000000
#define DT_N_S_servo3_P_pwms_IDX_0_VAL_period_EXISTS 1
#define DT_N_S_servo3_P_pwms_IDX_0_VAL_flags 0
#define DT_N_S_servo3_P_pwms_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_servo3_P_pwms_FOREACH_PROP_ELEM(fn) fn(DT_N_S_servo3, pwms, 0)
#define DT_N_S_servo3_P_pwms_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_servo3, pwms, 0)
#define DT_N_S_servo3_P_pwms_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_servo3, pwms, 0, __VA_ARGS__)
#define DT_N_S_servo3_P_pwms_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_servo3, pwms, 0, __VA_ARGS__)
#define DT_N_S_servo3_P_pwms_LEN 1
#define DT_N_S_servo3_P_pwms_EXISTS 1
#define DT_N_S_servo3_P_min_pulse 700000
#define DT_N_S_servo3_P_min_pulse_EXISTS 1
#define DT_N_S_servo3_P_max_pulse 2500000
#define DT_N_S_servo3_P_max_pulse_EXISTS 1
#define DT_N_S_servo3_P_compatible {"pwm-servo"}
#define DT_N_S_servo3_P_compatible_IDX_0 "pwm-servo"
#define DT_N_S_servo3_P_compatible_IDX_0_STRING_TOKEN pwm_servo
#define DT_N_S_servo3_P_compatible_IDX_0_STRING_UPPER_TOKEN PWM_SERVO
#define DT_N_S_servo3_P_compatible_IDX_0_EXISTS 1
#define DT_N_S_servo3_P_compatible_FOREACH_PROP_ELEM(fn) fn(DT_N_S_servo3, compatible, 0)
#define DT_N_S_servo3_P_compatible_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_servo3, compatible, 0)
#define DT_N_S_servo3_P_compatible_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_servo3, compatible, 0, __VA_ARGS__)
#define DT_N_S_servo3_P_compatible_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_servo3, compatible, 0, __VA_ARGS__)
#define DT_N_S_servo3_P_compatible_LEN 1
#define DT_N_S_servo3_P_compatible_EXISTS 1
#define DT_N_S_servo3_P_wakeup_source 0
#define DT_N_S_servo3_P_wakeup_source_EXISTS 1
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_gpio_40014000_ORD 18
...
/*
 * Devicetree node: /my_leds_node
 *
 * Node identifier: DT_N_S_my_leds_node
 *
 * Binding (compatible = gpio-leds):
 *   $ZEPHYR_BASE/dts/bindings/led/gpio-leds.yaml
 *
...
/* Node's full path: */
#define DT_N_S_my_leds_node_PATH "/my_leds_node"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_node_FULL_NAME "my_leds_node"

/* Node parent (/) identifier: */
#define DT_N_S_my_leds_node_PARENT DT_N

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_node_CHILD_IDX 7

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_node_FOREACH_CHILD(fn) fn(DT_N_S_my_leds_node_S_led_blue_node)
#define DT_N_S_my_leds_node_FOREACH_CHILD_SEP(fn, sep) fn(DT_N_S_my_leds_node_S_led_blue_node)
#define DT_N_S_my_leds_node_FOREACH_CHILD_VARGS(fn, ...) fn(DT_N_S_my_leds_node_S_led_blue_node, __VA_ARGS__)
#define DT_N_S_my_leds_node_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_node_S_led_blue_node, __VA_ARGS__)
#define DT_N_S_my_leds_node_FOREACH_CHILD_STATUS_OKAY(fn) fn(DT_N_S_my_leds_node_S_led_blue_node)
#define DT_N_S_my_leds_node_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) fn(DT_N_S_my_leds_node_S_led_blue_node)
#define DT_N_S_my_leds_node_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) fn(DT_N_S_my_leds_node_S_led_blue_node, __VA_ARGS__)
#define DT_N_S_my_leds_node_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_node_S_led_blue_node, __VA_ARGS__)

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_node_ORD 20

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_node_REQUIRES_ORDS \
	0, /* / */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_node_SUPPORTS_ORDS \
	21, /* /my_leds_node/led_blue_node */

/* Existence and alternate IDs: */
#define DT_N_S_my_leds_node_EXISTS 1
#define DT_N_INST_1_gpio_leds DT_N_S_my_leds_node

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_node_REG_NUM 0
#define DT_N_S_my_leds_node_RANGES_NUM 0
#define DT_N_S_my_leds_node_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_node_IRQ_NUM 0
#define DT_N_S_my_leds_node_COMPAT_MATCHES_gpio_leds 1
#define DT_N_S_my_leds_node_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_node_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_node_P_compatible {"gpio-leds"}
#define DT_N_S_my_leds_node_P_compatible_IDX_0 "gpio-leds"
#define DT_N_S_my_leds_node_P_compatible_IDX_0_STRING_TOKEN gpio_leds
#define DT_N_S_my_leds_node_P_compatible_IDX_0_STRING_UPPER_TOKEN GPIO_LEDS
#define DT_N_S_my_leds_node_P_compatible_IDX_0_EXISTS 1
#define DT_N_S_my_leds_node_P_compatible_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_node, compatible, 0)
#define DT_N_S_my_leds_node_P_compatible_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_node, compatible, 0)
#define DT_N_S_my_leds_node_P_compatible_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_node, compatible, 0, __VA_ARGS__)
#define DT_N_S_my_leds_node_P_compatible_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_node, compatible, 0, __VA_ARGS__)
#define DT_N_S_my_leds_node_P_compatible_LEN 1
#define DT_N_S_my_leds_node_P_compatible_EXISTS 1

/*
 * Devicetree node: /my_leds_node/led_blue_node
 *
 * Node identifier: DT_N_S_my_leds_node_S_led_blue_node
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_my_leds_node_S_led_blue_node_PATH "/my_leds_node/led_blue_node"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_node_S_led_blue_node_FULL_NAME "led_blue_node"

/* Node parent (/my_leds_node) identifier: */
#define DT_N_S_my_leds_node_S_led_blue_node_PARENT DT_N_S_my_leds_node

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_node_S_led_blue_node_CHILD_IDX 0

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_node_S_led_blue_node_FOREACH_CHILD(fn) 
#define DT_N_S_my_leds_node_S_led_blue_node_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_my_leds_node_S_led_blue_node_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_my_leds_node_S_led_blue_node_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_my_leds_node_S_led_blue_node_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_my_leds_node_S_led_blue_node_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_my_leds_node_S_led_blue_node_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_my_leds_node_S_led_blue_node_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_node_S_led_blue_node_ORD 21

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_node_S_led_blue_node_REQUIRES_ORDS \
	18, /* /soc/gpio@40014000 */ \
	20, /* /my_leds_node */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_node_S_led_blue_node_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_my_leds_node_S_led_blue_node_EXISTS 1
#define DT_N_ALIAS_led1               DT_N_S_my_leds_node_S_led_blue_node
#define DT_N_NODELABEL_led_blue_label DT_N_S_my_leds_node_S_led_blue_node

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_node_S_led_blue_node_REG_NUM 0
#define DT_N_S_my_leds_node_S_led_blue_node_RANGES_NUM 0
#define DT_N_S_my_leds_node_S_led_blue_node_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_node_S_led_blue_node_IRQ_NUM 0
#define DT_N_S_my_leds_node_S_led_blue_node_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_node_S_led_blue_node_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_node_S_led_blue_node_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_my_leds_node_S_led_blue_node_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_40014000
#define DT_N_S_my_leds_node_S_led_blue_node_P_gpios_IDX_0_VAL_pin 16
#define DT_N_S_my_leds_node_S_led_blue_node_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_my_leds_node_S_led_blue_node_P_gpios_IDX_0_VAL_flags 0
#define DT_N_S_my_leds_node_S_led_blue_node_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_my_leds_node_S_led_blue_node_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_node_S_led_blue_node, gpios, 0)
#define DT_N_S_my_leds_node_S_led_blue_node_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_node_S_led_blue_node, gpios, 0)
#define DT_N_S_my_leds_node_S_led_blue_node_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_node_S_led_blue_node, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_node_S_led_blue_node_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_node_S_led_blue_node, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_node_S_led_blue_node_P_gpios_LEN 1
#define DT_N_S_my_leds_node_S_led_blue_node_P_gpios_EXISTS 1

/*
 * Devicetree node: /my_leds_nodem
 *
 * Node identifier: DT_N_S_my_leds_nodem
 *
 * Binding (compatible = gpio-leds):
 *   $ZEPHYR_BASE/dts/bindings/led/gpio-leds.yaml
 *
...
/* Node's full path: */
#define DT_N_S_my_leds_nodem_PATH "/my_leds_nodem"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_nodem_FULL_NAME "my_leds_nodem"

/* Node parent (/) identifier: */
#define DT_N_S_my_leds_nodem_PARENT DT_N

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_nodem_CHILD_IDX 16

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_nodem_FOREACH_CHILD(fn) fn(DT_N_S_my_leds_nodem_S_echo1) fn(DT_N_S_my_leds_nodem_S_trig1) fn(DT_N_S_my_leds_nodem_S_echo2) fn(DT_N_S_my_leds_nodem_S_trig2) fn(DT_N_S_my_leds_nodem_S_echo3) fn(DT_N_S_my_leds_nodem_S_trig3) fn(DT_N_S_my_leds_nodem_S_echo4) fn(DT_N_S_my_leds_nodem_S_trig4)
#define DT_N_S_my_leds_nodem_FOREACH_CHILD_SEP(fn, sep) fn(DT_N_S_my_leds_nodem_S_echo1) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_trig1) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_echo2) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_trig2) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_echo3) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_trig3) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_echo4) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_trig4)
#define DT_N_S_my_leds_nodem_FOREACH_CHILD_VARGS(fn, ...) fn(DT_N_S_my_leds_nodem_S_echo1, __VA_ARGS__) fn(DT_N_S_my_leds_nodem_S_trig1, __VA_ARGS__) fn(DT_N_S_my_leds_nodem_S_echo2, __VA_ARGS__) fn(DT_N_S_my_leds_nodem_S_trig2, __VA_ARGS__) fn(DT_N_S_my_leds_nodem_S_echo3, __VA_ARGS__) fn(DT_N_S_my_leds_nodem_S_trig3, __VA_ARGS__) fn(DT_N_S_my_leds_nodem_S_echo4, __VA_ARGS__) fn(DT_N_S_my_leds_nodem_S_trig4, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodem_S_echo1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_trig1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_echo2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_trig2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_echo3, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_trig3, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_echo4, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_trig4, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_FOREACH_CHILD_STATUS_OKAY(fn) fn(DT_N_S_my_leds_nodem_S_echo1) fn(DT_N_S_my_leds_nodem_S_trig1) fn(DT_N_S_my_leds_nodem_S_echo2) fn(DT_N_S_my_leds_nodem_S_trig2) fn(DT_N_S_my_leds_nodem_S_echo3) fn(DT_N_S_my_leds_nodem_S_trig3) fn(DT_N_S_my_leds_nodem_S_echo4) fn(DT_N_S_my_leds_nodem_S_trig4)
#define DT_N_S_my_leds_nodem_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) fn(DT_N_S_my_leds_nodem_S_echo1) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_trig1) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_echo2) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_trig2) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_echo3) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_trig3) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_echo4) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_trig4)
#define DT_N_S_my_leds_nodem_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) fn(DT_N_S_my_leds_nodem_S_echo1, __VA_ARGS__) fn(DT_N_S_my_leds_nodem_S_trig1, __VA_ARGS__) fn(DT_N_S_my_leds_nodem_S_echo2, __VA_ARGS__) fn(DT_N_S_my_leds_nodem_S_trig2, __VA_ARGS__) fn(DT_N_S_my_leds_nodem_S_echo3, __VA_ARGS__) fn(DT_N_S_my_leds_nodem_S_trig3, __VA_ARGS__) fn(DT_N_S_my_leds_nodem_S_echo4, __VA_ARGS__) fn(DT_N_S_my_leds_nodem_S_trig4, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodem_S_echo1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_trig1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_echo2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_trig2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_echo3, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_trig3, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_echo4, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_my_leds_nodem_S_trig4, __VA_ARGS__)

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_nodem_ORD 22

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_nodem_REQUIRES_ORDS \
	0, /* / */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_nodem_SUPPORTS_ORDS \
	23, /* /my_leds_nodem/echo1 */ \
	24, /* /my_leds_nodem/echo2 */ \
	25, /* /my_leds_nodem/echo3 */ \
	26, /* /my_leds_nodem/echo4 */ \
...
/* Existence and alternate IDs: */
#define DT_N_S_my_leds_nodem_EXISTS 1
#define DT_N_INST_5_gpio_leds DT_N_S_my_leds_nodem

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_nodem_REG_NUM 0
#define DT_N_S_my_leds_nodem_RANGES_NUM 0
#define DT_N_S_my_leds_nodem_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_nodem_IRQ_NUM 0
#define DT_N_S_my_leds_nodem_COMPAT_MATCHES_gpio_leds 1
#define DT_N_S_my_leds_nodem_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_nodem_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_nodem_P_compatible {"gpio-leds"}
#define DT_N_S_my_leds_nodem_P_compatible_IDX_0 "gpio-leds"
#define DT_N_S_my_leds_nodem_P_compatible_IDX_0_STRING_TOKEN gpio_leds
#define DT_N_S_my_leds_nodem_P_compatible_IDX_0_STRING_UPPER_TOKEN GPIO_LEDS
#define DT_N_S_my_leds_nodem_P_compatible_IDX_0_EXISTS 1
#define DT_N_S_my_leds_nodem_P_compatible_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_nodem, compatible, 0)
#define DT_N_S_my_leds_nodem_P_compatible_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_nodem, compatible, 0)
#define DT_N_S_my_leds_nodem_P_compatible_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_nodem, compatible, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_P_compatible_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodem, compatible, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_P_compatible_LEN 1
#define DT_N_S_my_leds_nodem_P_compatible_EXISTS 1

/*
 * Devicetree node: /my_leds_nodem/echo1
 *
 * Node identifier: DT_N_S_my_leds_nodem_S_echo1
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_my_leds_nodem_S_echo1_PATH "/my_leds_nodem/echo1"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_nodem_S_echo1_FULL_NAME "echo1"

/* Node parent (/my_leds_nodem) identifier: */
#define DT_N_S_my_leds_nodem_S_echo1_PARENT DT_N_S_my_leds_nodem

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_nodem_S_echo1_CHILD_IDX 0

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_nodem_S_echo1_FOREACH_CHILD(fn) 
#define DT_N_S_my_leds_nodem_S_echo1_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_my_leds_nodem_S_echo1_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodem_S_echo1_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_my_leds_nodem_S_echo1_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_my_leds_nodem_S_echo1_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_my_leds_nodem_S_echo1_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodem_S_echo1_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_nodem_S_echo1_ORD 23

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_nodem_S_echo1_REQUIRES_ORDS \
	18, /* /soc/gpio@40014000 */ \
	22, /* /my_leds_nodem */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_nodem_S_echo1_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_my_leds_nodem_S_echo1_EXISTS 1
#define DT_N_ALIAS_echo1     DT_N_S_my_leds_nodem_S_echo1
#define DT_N_NODELABEL_echo1 DT_N_S_my_leds_nodem_S_echo1

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_nodem_S_echo1_REG_NUM 0
#define DT_N_S_my_leds_nodem_S_echo1_RANGES_NUM 0
#define DT_N_S_my_leds_nodem_S_echo1_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_nodem_S_echo1_IRQ_NUM 0
#define DT_N_S_my_leds_nodem_S_echo1_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_nodem_S_echo1_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_nodem_S_echo1_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_my_leds_nodem_S_echo1_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_40014000
#define DT_N_S_my_leds_nodem_S_echo1_P_gpios_IDX_0_VAL_pin 5
#define DT_N_S_my_leds_nodem_S_echo1_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_my_leds_nodem_S_echo1_P_gpios_IDX_0_VAL_flags 0
#define DT_N_S_my_leds_nodem_S_echo1_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_my_leds_nodem_S_echo1_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_nodem_S_echo1, gpios, 0)
#define DT_N_S_my_leds_nodem_S_echo1_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_nodem_S_echo1, gpios, 0)
#define DT_N_S_my_leds_nodem_S_echo1_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_nodem_S_echo1, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_S_echo1_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodem_S_echo1, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_S_echo1_P_gpios_LEN 1
#define DT_N_S_my_leds_nodem_S_echo1_P_gpios_EXISTS 1

/*
 * Devicetree node: /my_leds_nodem/echo2
 *
 * Node identifier: DT_N_S_my_leds_nodem_S_echo2
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_my_leds_nodem_S_echo2_PATH "/my_leds_nodem/echo2"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_nodem_S_echo2_FULL_NAME "echo2"

/* Node parent (/my_leds_nodem) identifier: */
#define DT_N_S_my_leds_nodem_S_echo2_PARENT DT_N_S_my_leds_nodem

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_nodem_S_echo2_CHILD_IDX 2

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_nodem_S_echo2_FOREACH_CHILD(fn) 
#define DT_N_S_my_leds_nodem_S_echo2_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_my_leds_nodem_S_echo2_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodem_S_echo2_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_my_leds_nodem_S_echo2_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_my_leds_nodem_S_echo2_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_my_leds_nodem_S_echo2_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodem_S_echo2_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_nodem_S_echo2_ORD 24

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_nodem_S_echo2_REQUIRES_ORDS \
	18, /* /soc/gpio@40014000 */ \
	22, /* /my_leds_nodem */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_nodem_S_echo2_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_my_leds_nodem_S_echo2_EXISTS 1
#define DT_N_ALIAS_echo2     DT_N_S_my_leds_nodem_S_echo2
#define DT_N_NODELABEL_echo2 DT_N_S_my_leds_nodem_S_echo2

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_nodem_S_echo2_REG_NUM 0
#define DT_N_S_my_leds_nodem_S_echo2_RANGES_NUM 0
#define DT_N_S_my_leds_nodem_S_echo2_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_nodem_S_echo2_IRQ_NUM 0
#define DT_N_S_my_leds_nodem_S_echo2_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_nodem_S_echo2_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_nodem_S_echo2_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_my_leds_nodem_S_echo2_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_40014000
#define DT_N_S_my_leds_nodem_S_echo2_P_gpios_IDX_0_VAL_pin 7
#define DT_N_S_my_leds_nodem_S_echo2_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_my_leds_nodem_S_echo2_P_gpios_IDX_0_VAL_flags 0
#define DT_N_S_my_leds_nodem_S_echo2_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_my_leds_nodem_S_echo2_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_nodem_S_echo2, gpios, 0)
#define DT_N_S_my_leds_nodem_S_echo2_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_nodem_S_echo2, gpios, 0)
#define DT_N_S_my_leds_nodem_S_echo2_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_nodem_S_echo2, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_S_echo2_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodem_S_echo2, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_S_echo2_P_gpios_LEN 1
#define DT_N_S_my_leds_nodem_S_echo2_P_gpios_EXISTS 1

/*
 * Devicetree node: /my_leds_nodem/echo3
 *
 * Node identifier: DT_N_S_my_leds_nodem_S_echo3
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_my_leds_nodem_S_echo3_PATH "/my_leds_nodem/echo3"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_nodem_S_echo3_FULL_NAME "echo3"

/* Node parent (/my_leds_nodem) identifier: */
#define DT_N_S_my_leds_nodem_S_echo3_PARENT DT_N_S_my_leds_nodem

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_nodem_S_echo3_CHILD_IDX 4

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_nodem_S_echo3_FOREACH_CHILD(fn) 
#define DT_N_S_my_leds_nodem_S_echo3_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_my_leds_nodem_S_echo3_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodem_S_echo3_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_my_leds_nodem_S_echo3_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_my_leds_nodem_S_echo3_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_my_leds_nodem_S_echo3_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodem_S_echo3_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_nodem_S_echo3_ORD 25

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_nodem_S_echo3_REQUIRES_ORDS \
	18, /* /soc/gpio@40014000 */ \
	22, /* /my_leds_nodem */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_nodem_S_echo3_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_my_leds_nodem_S_echo3_EXISTS 1
#define DT_N_ALIAS_echo3     DT_N_S_my_leds_nodem_S_echo3
#define DT_N_NODELABEL_echo3 DT_N_S_my_leds_nodem_S_echo3

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_nodem_S_echo3_REG_NUM 0
#define DT_N_S_my_leds_nodem_S_echo3_RANGES_NUM 0
#define DT_N_S_my_leds_nodem_S_echo3_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_nodem_S_echo3_IRQ_NUM 0
#define DT_N_S_my_leds_nodem_S_echo3_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_nodem_S_echo3_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_nodem_S_echo3_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_my_leds_nodem_S_echo3_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_40014000
#define DT_N_S_my_leds_nodem_S_echo3_P_gpios_IDX_0_VAL_pin 9
#define DT_N_S_my_leds_nodem_S_echo3_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_my_leds_nodem_S_echo3_P_gpios_IDX_0_VAL_flags 0
#define DT_N_S_my_leds_nodem_S_echo3_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_my_leds_nodem_S_echo3_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_nodem_S_echo3, gpios, 0)
#define DT_N_S_my_leds_nodem_S_echo3_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_nodem_S_echo3, gpios, 0)
#define DT_N_S_my_leds_nodem_S_echo3_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_nodem_S_echo3, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_S_echo3_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodem_S_echo3, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_S_echo3_P_gpios_LEN 1
#define DT_N_S_my_leds_nodem_S_echo3_P_gpios_EXISTS 1

/*
 * Devicetree node: /my_leds_nodem/echo4
 *
 * Node identifier: DT_N_S_my_leds_nodem_S_echo4
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_my_leds_nodem_S_echo4_PATH "/my_leds_nodem/echo4"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_nodem_S_echo4_FULL_NAME "echo4"

/* Node parent (/my_leds_nodem) identifier: */
#define DT_N_S_my_leds_nodem_S_echo4_PARENT DT_N_S_my_leds_nodem

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_nodem_S_echo4_CHILD_IDX 6

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_nodem_S_echo4_FOREACH_CHILD(fn) 
#define DT_N_S_my_leds_nodem_S_echo4_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_my_leds_nodem_S_echo4_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodem_S_echo4_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_my_leds_nodem_S_echo4_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_my_leds_nodem_S_echo4_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_my_leds_nodem_S_echo4_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodem_S_echo4_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_nodem_S_echo4_ORD 26

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_nodem_S_echo4_REQUIRES_ORDS \
	18, /* /soc/gpio@40014000 */ \
	22, /* /my_leds_nodem */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_nodem_S_echo4_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_my_leds_nodem_S_echo4_EXISTS 1
#define DT_N_ALIAS_echo4     DT_N_S_my_leds_nodem_S_echo4
#define DT_N_NODELABEL_echo4 DT_N_S_my_leds_nodem_S_echo4

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_nodem_S_echo4_REG_NUM 0
#define DT_N_S_my_leds_nodem_S_echo4_RANGES_NUM 0
#define DT_N_S_my_leds_nodem_S_echo4_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_nodem_S_echo4_IRQ_NUM 0
#define DT_N_S_my_leds_nodem_S_echo4_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_nodem_S_echo4_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_nodem_S_echo4_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_my_leds_nodem_S_echo4_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_40014000
#define DT_N_S_my_leds_nodem_S_echo4_P_gpios_IDX_0_VAL_pin 18
#define DT_N_S_my_leds_nodem_S_echo4_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_my_leds_nodem_S_echo4_P_gpios_IDX_0_VAL_flags 0
#define DT_N_S_my_leds_nodem_S_echo4_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_my_leds_nodem_S_echo4_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_nodem_S_echo4, gpios, 0)
#define DT_N_S_my_leds_nodem_S_echo4_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_nodem_S_echo4, gpios, 0)
#define DT_N_S_my_leds_nodem_S_echo4_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_nodem_S_echo4, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_S_echo4_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodem_S_echo4, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_S_echo4_P_gpios_LEN 1
#define DT_N_S_my_leds_nodem_S_echo4_P_gpios_EXISTS 1

/*
 * Devicetree node: /my_leds_nodem/trig1
 *
 * Node identifier: DT_N_S_my_leds_nodem_S_trig1
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_my_leds_nodem_S_trig1_PATH "/my_leds_nodem/trig1"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_nodem_S_trig1_FULL_NAME "trig1"

/* Node parent (/my_leds_nodem) identifier: */
#define DT_N_S_my_leds_nodem_S_trig1_PARENT DT_N_S_my_leds_nodem

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_nodem_S_trig1_CHILD_IDX 1

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_nodem_S_trig1_FOREACH_CHILD(fn) 
#define DT_N_S_my_leds_nodem_S_trig1_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_my_leds_nodem_S_trig1_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodem_S_trig1_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_my_leds_nodem_S_trig1_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_my_leds_nodem_S_trig1_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_my_leds_nodem_S_trig1_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodem_S_trig1_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_nodem_S_trig1_ORD 27

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_nodem_S_trig1_REQUIRES_ORDS \
	18, /* /soc/gpio@40014000 */ \
	22, /* /my_leds_nodem */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_nodem_S_trig1_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_my_leds_nodem_S_trig1_EXISTS 1
#define DT_N_ALIAS_trig1     DT_N_S_my_leds_nodem_S_trig1
#define DT_N_NODELABEL_trig1 DT_N_S_my_leds_nodem_S_trig1

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_nodem_S_trig1_REG_NUM 0
#define DT_N_S_my_leds_nodem_S_trig1_RANGES_NUM 0
#define DT_N_S_my_leds_nodem_S_trig1_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_nodem_S_trig1_IRQ_NUM 0
#define DT_N_S_my_leds_nodem_S_trig1_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_nodem_S_trig1_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_nodem_S_trig1_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_my_leds_nodem_S_trig1_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_40014000
#define DT_N_S_my_leds_nodem_S_trig1_P_gpios_IDX_0_VAL_pin 6
#define DT_N_S_my_leds_nodem_S_trig1_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_my_leds_nodem_S_trig1_P_gpios_IDX_0_VAL_flags 0
#define DT_N_S_my_leds_nodem_S_trig1_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_my_leds_nodem_S_trig1_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_nodem_S_trig1, gpios, 0)
#define DT_N_S_my_leds_nodem_S_trig1_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_nodem_S_trig1, gpios, 0)
#define DT_N_S_my_leds_nodem_S_trig1_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_nodem_S_trig1, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_S_trig1_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodem_S_trig1, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_S_trig1_P_gpios_LEN 1
#define DT_N_S_my_leds_nodem_S_trig1_P_gpios_EXISTS 1

/*
 * Devicetree node: /my_leds_nodem/trig2
 *
 * Node identifier: DT_N_S_my_leds_nodem_S_trig2
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_my_leds_nodem_S_trig2_PATH "/my_leds_nodem/trig2"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_nodem_S_trig2_FULL_NAME "trig2"

/* Node parent (/my_leds_nodem) identifier: */
#define DT_N_S_my_leds_nodem_S_trig2_PARENT DT_N_S_my_leds_nodem

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_nodem_S_trig2_CHILD_IDX 3

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_nodem_S_trig2_FOREACH_CHILD(fn) 
#define DT_N_S_my_leds_nodem_S_trig2_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_my_leds_nodem_S_trig2_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodem_S_trig2_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_my_leds_nodem_S_trig2_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_my_leds_nodem_S_trig2_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_my_leds_nodem_S_trig2_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodem_S_trig2_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_nodem_S_trig2_ORD 28

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_nodem_S_trig2_REQUIRES_ORDS \
	18, /* /soc/gpio@40014000 */ \
	22, /* /my_leds_nodem */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_nodem_S_trig2_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_my_leds_nodem_S_trig2_EXISTS 1
#define DT_N_ALIAS_trig2     DT_N_S_my_leds_nodem_S_trig2
#define DT_N_NODELABEL_trig2 DT_N_S_my_leds_nodem_S_trig2

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_nodem_S_trig2_REG_NUM 0
#define DT_N_S_my_leds_nodem_S_trig2_RANGES_NUM 0
#define DT_N_S_my_leds_nodem_S_trig2_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_nodem_S_trig2_IRQ_NUM 0
#define DT_N_S_my_leds_nodem_S_trig2_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_nodem_S_trig2_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_nodem_S_trig2_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_my_leds_nodem_S_trig2_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_40014000
#define DT_N_S_my_leds_nodem_S_trig2_P_gpios_IDX_0_VAL_pin 8
#define DT_N_S_my_leds_nodem_S_trig2_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_my_leds_nodem_S_trig2_P_gpios_IDX_0_VAL_flags 0
#define DT_N_S_my_leds_nodem_S_trig2_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_my_leds_nodem_S_trig2_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_nodem_S_trig2, gpios, 0)
#define DT_N_S_my_leds_nodem_S_trig2_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_nodem_S_trig2, gpios, 0)
#define DT_N_S_my_leds_nodem_S_trig2_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_nodem_S_trig2, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_S_trig2_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodem_S_trig2, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_S_trig2_P_gpios_LEN 1
#define DT_N_S_my_leds_nodem_S_trig2_P_gpios_EXISTS 1

/*
 * Devicetree node: /my_leds_nodem/trig3
 *
 * Node identifier: DT_N_S_my_leds_nodem_S_trig3
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_my_leds_nodem_S_trig3_PATH "/my_leds_nodem/trig3"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_nodem_S_trig3_FULL_NAME "trig3"

/* Node parent (/my_leds_nodem) identifier: */
#define DT_N_S_my_leds_nodem_S_trig3_PARENT DT_N_S_my_leds_nodem

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_nodem_S_trig3_CHILD_IDX 5

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_nodem_S_trig3_FOREACH_CHILD(fn) 
#define DT_N_S_my_leds_nodem_S_trig3_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_my_leds_nodem_S_trig3_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodem_S_trig3_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_my_leds_nodem_S_trig3_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_my_leds_nodem_S_trig3_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_my_leds_nodem_S_trig3_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodem_S_trig3_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_nodem_S_trig3_ORD 29

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_nodem_S_trig3_REQUIRES_ORDS \
	18, /* /soc/gpio@40014000 */ \
	22, /* /my_leds_nodem */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_nodem_S_trig3_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_my_leds_nodem_S_trig3_EXISTS 1
#define DT_N_ALIAS_trig3     DT_N_S_my_leds_nodem_S_trig3
#define DT_N_NODELABEL_trig3 DT_N_S_my_leds_nodem_S_trig3

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_nodem_S_trig3_REG_NUM 0
#define DT_N_S_my_leds_nodem_S_trig3_RANGES_NUM 0
#define DT_N_S_my_leds_nodem_S_trig3_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_nodem_S_trig3_IRQ_NUM 0
#define DT_N_S_my_leds_nodem_S_trig3_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_nodem_S_trig3_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_nodem_S_trig3_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_my_leds_nodem_S_trig3_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_40014000
#define DT_N_S_my_leds_nodem_S_trig3_P_gpios_IDX_0_VAL_pin 10
#define DT_N_S_my_leds_nodem_S_trig3_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_my_leds_nodem_S_trig3_P_gpios_IDX_0_VAL_flags 0
#define DT_N_S_my_leds_nodem_S_trig3_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_my_leds_nodem_S_trig3_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_nodem_S_trig3, gpios, 0)
#define DT_N_S_my_leds_nodem_S_trig3_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_nodem_S_trig3, gpios, 0)
#define DT_N_S_my_leds_nodem_S_trig3_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_nodem_S_trig3, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_S_trig3_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodem_S_trig3, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_S_trig3_P_gpios_LEN 1
#define DT_N_S_my_leds_nodem_S_trig3_P_gpios_EXISTS 1

/*
 * Devicetree node: /my_leds_nodem/trig4
 *
 * Node identifier: DT_N_S_my_leds_nodem_S_trig4
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_my_leds_nodem_S_trig4_PATH "/my_leds_nodem/trig4"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_nodem_S_trig4_FULL_NAME "trig4"

/* Node parent (/my_leds_nodem) identifier: */
#define DT_N_S_my_leds_nodem_S_trig4_PARENT DT_N_S_my_leds_nodem

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_nodem_S_trig4_CHILD_IDX 7

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_nodem_S_trig4_FOREACH_CHILD(fn) 
#define DT_N_S_my_leds_nodem_S_trig4_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_my_leds_nodem_S_trig4_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodem_S_trig4_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_my_leds_nodem_S_trig4_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_my_leds_nodem_S_trig4_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_my_leds_nodem_S_trig4_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodem_S_trig4_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_nodem_S_trig4_ORD 30

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_nodem_S_trig4_REQUIRES_ORDS \
	18, /* /soc/gpio@40014000 */ \
	22, /* /my_leds_nodem */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_nodem_S_trig4_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_my_leds_nodem_S_trig4_EXISTS 1
#define DT_N_ALIAS_trig4     DT_N_S_my_leds_nodem_S_trig4
#define DT_N_NODELABEL_trig4 DT_N_S_my_leds_nodem_S_trig4

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_nodem_S_trig4_REG_NUM 0
#define DT_N_S_my_leds_nodem_S_trig4_RANGES_NUM 0
#define DT_N_S_my_leds_nodem_S_trig4_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_nodem_S_trig4_IRQ_NUM 0
#define DT_N_S_my_leds_nodem_S_trig4_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_nodem_S_trig4_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_nodem_S_trig4_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_my_leds_nodem_S_trig4_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_40014000
#define DT_N_S_my_leds_nodem_S_trig4_P_gpios_IDX_0_VAL_pin 26
#define DT_N_S_my_leds_nodem_S_trig4_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_my_leds_nodem_S_trig4_P_gpios_IDX_0_VAL_flags 0
#define DT_N_S_my_leds_nodem_S_trig4_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_my_leds_nodem_S_trig4_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_nodem_S_trig4, gpios, 0)
#define DT_N_S_my_leds_nodem_S_trig4_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_nodem_S_trig4, gpios, 0)
#define DT_N_S_my_leds_nodem_S_trig4_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_nodem_S_trig4, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_S_trig4_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodem_S_trig4, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodem_S_trig4_P_gpios_LEN 1
#define DT_N_S_my_leds_nodem_S_trig4_P_gpios_EXISTS 1

/*
 * Devicetree node: /my_leds_nodes
 *
 * Node identifier: DT_N_S_my_leds_nodes
 *
 * Binding (compatible = gpio-leds):
 *   $ZEPHYR_BASE/dts/bindings/led/gpio-leds.yaml
 *
...
/* Node's full path: */
#define DT_N_S_my_leds_nodes_PATH "/my_leds_nodes"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_nodes_FULL_NAME "my_leds_nodes"

/* Node parent (/) identifier: */
#define DT_N_S_my_leds_nodes_PARENT DT_N

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_nodes_CHILD_IDX 8

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_nodes_FOREACH_CHILD(fn) fn(DT_N_S_my_leds_nodes_S_led_green_node)
#define DT_N_S_my_leds_nodes_FOREACH_CHILD_SEP(fn, sep) fn(DT_N_S_my_leds_nodes_S_led_green_node)
#define DT_N_S_my_leds_nodes_FOREACH_CHILD_VARGS(fn, ...) fn(DT_N_S_my_leds_nodes_S_led_green_node, __VA_ARGS__)
#define DT_N_S_my_leds_nodes_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodes_S_led_green_node, __VA_ARGS__)
#define DT_N_S_my_leds_nodes_FOREACH_CHILD_STATUS_OKAY(fn) fn(DT_N_S_my_leds_nodes_S_led_green_node)
#define DT_N_S_my_leds_nodes_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) fn(DT_N_S_my_leds_nodes_S_led_green_node)
#define DT_N_S_my_leds_nodes_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) fn(DT_N_S_my_leds_nodes_S_led_green_node, __VA_ARGS__)
#define DT_N_S_my_leds_nodes_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodes_S_led_green_node, __VA_ARGS__)

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_nodes_ORD 31

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_nodes_REQUIRES_ORDS \
	0, /* / */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_nodes_SUPPORTS_ORDS \
	32, /* /my_leds_nodes/led_green_node */

/* Existence and alternate IDs: */
#define DT_N_S_my_leds_nodes_EXISTS 1
#define DT_N_INST_2_gpio_leds DT_N_S_my_leds_nodes

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_nodes_REG_NUM 0
#define DT_N_S_my_leds_nodes_RANGES_NUM 0
#define DT_N_S_my_leds_nodes_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_nodes_IRQ_NUM 0
#define DT_N_S_my_leds_nodes_COMPAT_MATCHES_gpio_leds 1
#define DT_N_S_my_leds_nodes_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_nodes_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_nodes_P_compatible {"gpio-leds"}
#define DT_N_S_my_leds_nodes_P_compatible_IDX_0 "gpio-leds"
#define DT_N_S_my_leds_nodes_P_compatible_IDX_0_STRING_TOKEN gpio_leds
#define DT_N_S_my_leds_nodes_P_compatible_IDX_0_STRING_UPPER_TOKEN GPIO_LEDS
#define DT_N_S_my_leds_nodes_P_compatible_IDX_0_EXISTS 1
#define DT_N_S_my_leds_nodes_P_compatible_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_nodes, compatible, 0)
#define DT_N_S_my_leds_nodes_P_compatible_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_nodes, compatible, 0)
#define DT_N_S_my_leds_nodes_P_compatible_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_nodes, compatible, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodes_P_compatible_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodes, compatible, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodes_P_compatible_LEN 1
#define DT_N_S_my_leds_nodes_P_compatible_EXISTS 1

/*
 * Devicetree node: /my_leds_nodes/led_green_node
 *
 * Node identifier: DT_N_S_my_leds_nodes_S_led_green_node
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_my_leds_nodes_S_led_green_node_PATH "/my_leds_nodes/led_green_node"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_nodes_S_led_green_node_FULL_NAME "led_green_node"

/* Node parent (/my_leds_nodes) identifier: */
#define DT_N_S_my_leds_nodes_S_led_green_node_PARENT DT_N_S_my_leds_nodes

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_nodes_S_led_green_node_CHILD_IDX 0

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_nodes_S_led_green_node_FOREACH_CHILD(fn) 
#define DT_N_S_my_leds_nodes_S_led_green_node_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_my_leds_nodes_S_led_green_node_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodes_S_led_green_node_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_my_leds_nodes_S_led_green_node_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_my_leds_nodes_S_led_green_node_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_my_leds_nodes_S_led_green_node_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodes_S_led_green_node_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_nodes_S_led_green_node_ORD 32

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_nodes_S_led_green_node_REQUIRES_ORDS \
	18, /* /soc/gpio@40014000 */ \
	31, /* /my_leds_nodes */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_nodes_S_led_green_node_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_my_leds_nodes_S_led_green_node_EXISTS 1
#define DT_N_ALIAS_led2                DT_N_S_my_leds_nodes_S_led_green_node
#define DT_N_NODELABEL_led_green_label DT_N_S_my_leds_nodes_S_led_green_node

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_nodes_S_led_green_node_REG_NUM 0
#define DT_N_S_my_leds_nodes_S_led_green_node_RANGES_NUM 0
#define DT_N_S_my_leds_nodes_S_led_green_node_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_nodes_S_led_green_node_IRQ_NUM 0
#define DT_N_S_my_leds_nodes_S_led_green_node_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_nodes_S_led_green_node_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_nodes_S_led_green_node_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_my_leds_nodes_S_led_green_node_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_40014000
#define DT_N_S_my_leds_nodes_S_led_green_node_P_gpios_IDX_0_VAL_pin 17
#define DT_N_S_my_leds_nodes_S_led_green_node_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_my_leds_nodes_S_led_green_node_P_gpios_IDX_0_VAL_flags 0
#define DT_N_S_my_leds_nodes_S_led_green_node_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_my_leds_nodes_S_led_green_node_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_nodes_S_led_green_node, gpios, 0)
#define DT_N_S_my_leds_nodes_S_led_green_node_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_nodes_S_led_green_node, gpios, 0)
#define DT_N_S_my_leds_nodes_S_led_green_node_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_nodes_S_led_green_node, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodes_S_led_green_node_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodes_S_led_green_node, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodes_S_led_green_node_P_gpios_LEN 1
#define DT_N_S_my_leds_nodes_S_led_green_node_P_gpios_EXISTS 1

/*
 * Devicetree node: /my_leds_nodes1
 *
 * Node identifier: DT_N_S_my_leds_nodes1
 *
 * Binding (compatible = gpio-leds):
 *   $ZEPHYR_BASE/dts/bindings/led/gpio-leds.yaml
 *
...
/* Node's full path: */
#define DT_N_S_my_leds_nodes1_PATH "/my_leds_nodes1"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_nodes1_FULL_NAME "my_leds_nodes1"

/* Node parent (/) identifier: */
#define DT_N_S_my_leds_nodes1_PARENT DT_N

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_nodes1_CHILD_IDX 9

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_nodes1_FOREACH_CHILD(fn) fn(DT_N_S_my_leds_nodes1_S_led_red_node)
#define DT_N_S_my_leds_nodes1_FOREACH_CHILD_SEP(fn, sep) fn(DT_N_S_my_leds_nodes1_S_led_red_node)
#define DT_N_S_my_leds_nodes1_FOREACH_CHILD_VARGS(fn, ...) fn(DT_N_S_my_leds_nodes1_S_led_red_node, __VA_ARGS__)
#define DT_N_S_my_leds_nodes1_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodes1_S_led_red_node, __VA_ARGS__)
#define DT_N_S_my_leds_nodes1_FOREACH_CHILD_STATUS_OKAY(fn) fn(DT_N_S_my_leds_nodes1_S_led_red_node)
#define DT_N_S_my_leds_nodes1_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) fn(DT_N_S_my_leds_nodes1_S_led_red_node)
#define DT_N_S_my_leds_nodes1_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) fn(DT_N_S_my_leds_nodes1_S_led_red_node, __VA_ARGS__)
#define DT_N_S_my_leds_nodes1_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodes1_S_led_red_node, __VA_ARGS__)

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_nodes1_ORD 33

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_nodes1_REQUIRES_ORDS \
	0, /* / */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_nodes1_SUPPORTS_ORDS \
	34, /* /my_leds_nodes1/led_red_node */

/* Existence and alternate IDs: */
#define DT_N_S_my_leds_nodes1_EXISTS 1
#define DT_N_INST_3_gpio_leds DT_N_S_my_leds_nodes1

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_nodes1_REG_NUM 0
#define DT_N_S_my_leds_nodes1_RANGES_NUM 0
#define DT_N_S_my_leds_nodes1_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_nodes1_IRQ_NUM 0
#define DT_N_S_my_leds_nodes1_COMPAT_MATCHES_gpio_leds 1
#define DT_N_S_my_leds_nodes1_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_nodes1_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_nodes1_P_compatible {"gpio-leds"}
#define DT_N_S_my_leds_nodes1_P_compatible_IDX_0 "gpio-leds"
#define DT_N_S_my_leds_nodes1_P_compatible_IDX_0_STRING_TOKEN gpio_leds
#define DT_N_S_my_leds_nodes1_P_compatible_IDX_0_STRING_UPPER_TOKEN GPIO_LEDS
#define DT_N_S_my_leds_nodes1_P_compatible_IDX_0_EXISTS 1
#define DT_N_S_my_leds_nodes1_P_compatible_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_nodes1, compatible, 0)
#define DT_N_S_my_leds_nodes1_P_compatible_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_nodes1, compatible, 0)
#define DT_N_S_my_leds_nodes1_P_compatible_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_nodes1, compatible, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodes1_P_compatible_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodes1, compatible, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodes1_P_compatible_LEN 1
#define DT_N_S_my_leds_nodes1_P_compatible_EXISTS 1

/*
 * Devicetree node: /my_leds_nodes1/led_red_node
 *
 * Node identifier: DT_N_S_my_leds_nodes1_S_led_red_node
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_my_leds_nodes1_S_led_red_node_PATH "/my_leds_nodes1/led_red_node"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_nodes1_S_led_red_node_FULL_NAME "led_red_node"

/* Node parent (/my_leds_nodes1) identifier: */
#define DT_N_S_my_leds_nodes1_S_led_red_node_PARENT DT_N_S_my_leds_nodes1

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_nodes1_S_led_red_node_CHILD_IDX 0

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_nodes1_S_led_red_node_FOREACH_CHILD(fn) 
#define DT_N_S_my_leds_nodes1_S_led_red_node_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_my_leds_nodes1_S_led_red_node_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodes1_S_led_red_node_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_my_leds_nodes1_S_led_red_node_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_my_leds_nodes1_S_led_red_node_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_my_leds_nodes1_S_led_red_node_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodes1_S_led_red_node_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_nodes1_S_led_red_node_ORD 34

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_nodes1_S_led_red_node_REQUIRES_ORDS \
	18, /* /soc/gpio@40014000 */ \
	33, /* /my_leds_nodes1 */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_nodes1_S_led_red_node_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_my_leds_nodes1_S_led_red_node_EXISTS 1
#define DT_N_ALIAS_led3              DT_N_S_my_leds_nodes1_S_led_red_node
#define DT_N_NODELABEL_led_red_label DT_N_S_my_leds_nodes1_S_led_red_node

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_nodes1_S_led_red_node_REG_NUM 0
#define DT_N_S_my_leds_nodes1_S_led_red_node_RANGES_NUM 0
#define DT_N_S_my_leds_nodes1_S_led_red_node_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_nodes1_S_led_red_node_IRQ_NUM 0
#define DT_N_S_my_leds_nodes1_S_led_red_node_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_nodes1_S_led_red_node_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_nodes1_S_led_red_node_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_my_leds_nodes1_S_led_red_node_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_40014000
#define DT_N_S_my_leds_nodes1_S_led_red_node_P_gpios_IDX_0_VAL_pin 14
#define DT_N_S_my_leds_nodes1_S_led_red_node_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_my_leds_nodes1_S_led_red_node_P_gpios_IDX_0_VAL_flags 0
#define DT_N_S_my_leds_nodes1_S_led_red_node_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_my_leds_nodes1_S_led_red_node_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_nodes1_S_led_red_node, gpios, 0)
#define DT_N_S_my_leds_nodes1_S_led_red_node_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_nodes1_S_led_red_node, gpios, 0)
#define DT_N_S_my_leds_nodes1_S_led_red_node_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_nodes1_S_led_red_node, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodes1_S_led_red_node_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodes1_S_led_red_node, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodes1_S_led_red_node_P_gpios_LEN 1
#define DT_N_S_my_leds_nodes1_S_led_red_node_P_gpios_EXISTS 1

/*
 * Devicetree node: /my_leds_nodes2
 *
 * Node identifier: DT_N_S_my_leds_nodes2
 *
 * Binding (compatible = gpio-leds):
 *   $ZEPHYR_BASE/dts/bindings/led/gpio-leds.yaml
 *
...
/* Node's full path: */
#define DT_N_S_my_leds_nodes2_PATH "/my_leds_nodes2"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_nodes2_FULL_NAME "my_leds_nodes2"

/* Node parent (/) identifier: */
#define DT_N_S_my_leds_nodes2_PARENT DT_N

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_nodes2_CHILD_IDX 10

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_nodes2_FOREACH_CHILD(fn) fn(DT_N_S_my_leds_nodes2_S_led_pink_node)
#define DT_N_S_my_leds_nodes2_FOREACH_CHILD_SEP(fn, sep) fn(DT_N_S_my_leds_nodes2_S_led_pink_node)
#define DT_N_S_my_leds_nodes2_FOREACH_CHILD_VARGS(fn, ...) fn(DT_N_S_my_leds_nodes2_S_led_pink_node, __VA_ARGS__)
#define DT_N_S_my_leds_nodes2_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodes2_S_led_pink_node, __VA_ARGS__)
#define DT_N_S_my_leds_nodes2_FOREACH_CHILD_STATUS_OKAY(fn) fn(DT_N_S_my_leds_nodes2_S_led_pink_node)
#define DT_N_S_my_leds_nodes2_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) fn(DT_N_S_my_leds_nodes2_S_led_pink_node)
#define DT_N_S_my_leds_nodes2_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) fn(DT_N_S_my_leds_nodes2_S_led_pink_node, __VA_ARGS__)
#define DT_N_S_my_leds_nodes2_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodes2_S_led_pink_node, __VA_ARGS__)

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_nodes2_ORD 35

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_nodes2_REQUIRES_ORDS \
	0, /* / */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_nodes2_SUPPORTS_ORDS \
	36, /* /my_leds_nodes2/led_pink_node */

/* Existence and alternate IDs: */
#define DT_N_S_my_leds_nodes2_EXISTS 1
#define DT_N_INST_4_gpio_leds DT_N_S_my_leds_nodes2

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_nodes2_REG_NUM 0
#define DT_N_S_my_leds_nodes2_RANGES_NUM 0
#define DT_N_S_my_leds_nodes2_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_nodes2_IRQ_NUM 0
#define DT_N_S_my_leds_nodes2_COMPAT_MATCHES_gpio_leds 1
#define DT_N_S_my_leds_nodes2_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_nodes2_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_nodes2_P_compatible {"gpio-leds"}
#define DT_N_S_my_leds_nodes2_P_compatible_IDX_0 "gpio-leds"
#define DT_N_S_my_leds_nodes2_P_compatible_IDX_0_STRING_TOKEN gpio_leds
#define DT_N_S_my_leds_nodes2_P_compatible_IDX_0_STRING_UPPER_TOKEN GPIO_LEDS
#define DT_N_S_my_leds_nodes2_P_compatible_IDX_0_EXISTS 1
#define DT_N_S_my_leds_nodes2_P_compatible_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_nodes2, compatible, 0)
#define DT_N_S_my_leds_nodes2_P_compatible_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_nodes2, compatible, 0)
#define DT_N_S_my_leds_nodes2_P_compatible_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_nodes2, compatible, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodes2_P_compatible_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodes2, compatible, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodes2_P_compatible_LEN 1
#define DT_N_S_my_leds_nodes2_P_compatible_EXISTS 1

/*
 * Devicetree node: /my_leds_nodes2/led_pink_node
 *
 * Node identifier: DT_N_S_my_leds_nodes2_S_led_pink_node
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_my_leds_nodes2_S_led_pink_node_PATH "/my_leds_nodes2/led_pink_node"

/* Node's name with unit-address: */
#define DT_N_S_my_leds_nodes2_S_led_pink_node_FULL_NAME "led_pink_node"

/* Node parent (/my_leds_nodes2) identifier: */
#define DT_N_S_my_leds_nodes2_S_led_pink_node_PARENT DT_N_S_my_leds_nodes2

/* Node's index in its parent's list of children: */
#define DT_N_S_my_leds_nodes2_S_led_pink_node_CHILD_IDX 0

/* Helper macros for child nodes of this node. */
#define DT_N_S_my_leds_nodes2_S_led_pink_node_FOREACH_CHILD(fn) 
#define DT_N_S_my_leds_nodes2_S_led_pink_node_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_my_leds_nodes2_S_led_pink_node_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodes2_S_led_pink_node_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_my_leds_nodes2_S_led_pink_node_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_my_leds_nodes2_S_led_pink_node_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_my_leds_nodes2_S_led_pink_node_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_my_leds_nodes2_S_led_pink_node_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_my_leds_nodes2_S_led_pink_node_ORD 36

/* Ordinals for what this node depends on directly: */
#define DT_N_S_my_leds_nodes2_S_led_pink_node_REQUIRES_ORDS \
	18, /* /soc/gpio@40014000 */ \
	35, /* /my_leds_nodes2 */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_my_leds_nodes2_S_led_pink_node_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_my_leds_nodes2_S_led_pink_node_EXISTS 1
#define DT_N_ALIAS_led4               DT_N_S_my_leds_nodes2_S_led_pink_node
#define DT_N_NODELABEL_led_pink_label DT_N_S_my_leds_nodes2_S_led_pink_node

/* Macros for properties that are special in the specification: */
#define DT_N_S_my_leds_nodes2_S_led_pink_node_REG_NUM 0
#define DT_N_S_my_leds_nodes2_S_led_pink_node_RANGES_NUM 0
#define DT_N_S_my_leds_nodes2_S_led_pink_node_FOREACH_RANGE(fn) 
#define DT_N_S_my_leds_nodes2_S_led_pink_node_IRQ_NUM 0
#define DT_N_S_my_leds_nodes2_S_led_pink_node_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_my_leds_nodes2_S_led_pink_node_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_my_leds_nodes2_S_led_pink_node_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_my_leds_nodes2_S_led_pink_node_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_40014000
#define DT_N_S_my_leds_nodes2_S_led_pink_node_P_gpios_IDX_0_VAL_pin 15
#define DT_N_S_my_leds_nodes2_S_led_pink_node_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_my_leds_nodes2_S_led_pink_node_P_gpios_IDX_0_VAL_flags 0
#define DT_N_S_my_leds_nodes2_S_led_pink_node_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_my_leds_nodes2_S_led_pink_node_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_my_leds_nodes2_S_led_pink_node, gpios, 0)
#define DT_N_S_my_leds_nodes2_S_led_pink_node_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_my_leds_nodes2_S_led_pink_node, gpios, 0)
#define DT_N_S_my_leds_nodes2_S_led_pink_node_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_my_leds_nodes2_S_led_pink_node, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodes2_S_led_pink_node_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_my_leds_nodes2_S_led_pink_node, gpios, 0, __VA_ARGS__)
#define DT_N_S_my_leds_nodes2_S_led_pink_node_P_gpios_LEN 1
#define DT_N_S_my_leds_nodes2_S_led_pink_node_P_gpios_EXISTS 1
...
/* Node's dependency ordinal: */
#define DT_N_S_pwm_leds_S_pwm_led_0_ORD 38
...
/*
 * Devicetree node: /pwm_leds1
 *
 * Node identifier: DT_N_S_pwm_leds1
 *
 * Binding (compatible = pwm-leds):
 *   $ZEPHYR_BASE/dts/bindings/led/pwm-leds.yaml
 *
...
/* Node's full path: */
#define DT_N_S_pwm_leds1_PATH "/pwm_leds1"

/* Node's name with unit-address: */
#define DT_N_S_pwm_leds1_FULL_NAME "pwm_leds1"

/* Node parent (/) identifier: */
#define DT_N_S_pwm_leds1_PARENT DT_N

/* Node's index in its parent's list of children: */
#define DT_N_S_pwm_leds1_CHILD_IDX 11

/* Helper macros for child nodes of this node. */
#define DT_N_S_pwm_leds1_FOREACH_CHILD(fn) fn(DT_N_S_pwm_leds1_S_pwm_led_1) fn(DT_N_S_pwm_leds1_S_pwm_led_3)
#define DT_N_S_pwm_leds1_FOREACH_CHILD_SEP(fn, sep) fn(DT_N_S_pwm_leds1_S_pwm_led_1) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_pwm_leds1_S_pwm_led_3)
#define DT_N_S_pwm_leds1_FOREACH_CHILD_VARGS(fn, ...) fn(DT_N_S_pwm_leds1_S_pwm_led_1, __VA_ARGS__) fn(DT_N_S_pwm_leds1_S_pwm_led_3, __VA_ARGS__)
#define DT_N_S_pwm_leds1_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) fn(DT_N_S_pwm_leds1_S_pwm_led_1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_pwm_leds1_S_pwm_led_3, __VA_ARGS__)
#define DT_N_S_pwm_leds1_FOREACH_CHILD_STATUS_OKAY(fn) fn(DT_N_S_pwm_leds1_S_pwm_led_1) fn(DT_N_S_pwm_leds1_S_pwm_led_3)
#define DT_N_S_pwm_leds1_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) fn(DT_N_S_pwm_leds1_S_pwm_led_1) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_pwm_leds1_S_pwm_led_3)
#define DT_N_S_pwm_leds1_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) fn(DT_N_S_pwm_leds1_S_pwm_led_1, __VA_ARGS__) fn(DT_N_S_pwm_leds1_S_pwm_led_3, __VA_ARGS__)
#define DT_N_S_pwm_leds1_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) fn(DT_N_S_pwm_leds1_S_pwm_led_1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_pwm_leds1_S_pwm_led_3, __VA_ARGS__)

/* Node's dependency ordinal: */
#define DT_N_S_pwm_leds1_ORD 39

/* Ordinals for what this node depends on directly: */
#define DT_N_S_pwm_leds1_REQUIRES_ORDS \
	0, /* / */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_pwm_leds1_SUPPORTS_ORDS \
	40, /* /pwm_leds1/pwm_led_1 */ \
	41, /* /pwm_leds1/pwm_led_3 */

/* Existence and alternate IDs: */
#define DT_N_S_pwm_leds1_EXISTS 1
#define DT_N_INST_1_pwm_leds DT_N_S_pwm_leds1

/* Macros for properties that are special in the specification: */
#define DT_N_S_pwm_leds1_REG_NUM 0
#define DT_N_S_pwm_leds1_RANGES_NUM 0
#define DT_N_S_pwm_leds1_FOREACH_RANGE(fn) 
#define DT_N_S_pwm_leds1_IRQ_NUM 0
#define DT_N_S_pwm_leds1_COMPAT_MATCHES_pwm_leds 1
#define DT_N_S_pwm_leds1_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_pwm_leds1_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_pwm_leds1_P_compatible {"pwm-leds"}
#define DT_N_S_pwm_leds1_P_compatible_IDX_0 "pwm-leds"
#define DT_N_S_pwm_leds1_P_compatible_IDX_0_STRING_TOKEN pwm_leds
#define DT_N_S_pwm_leds1_P_compatible_IDX_0_STRING_UPPER_TOKEN PWM_LEDS
#define DT_N_S_pwm_leds1_P_compatible_IDX_0_EXISTS 1
#define DT_N_S_pwm_leds1_P_compatible_FOREACH_PROP_ELEM(fn) fn(DT_N_S_pwm_leds1, compatible, 0)
#define DT_N_S_pwm_leds1_P_compatible_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_pwm_leds1, compatible, 0)
#define DT_N_S_pwm_leds1_P_compatible_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_pwm_leds1, compatible, 0, __VA_ARGS__)
#define DT_N_S_pwm_leds1_P_compatible_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_pwm_leds1, compatible, 0, __VA_ARGS__)
#define DT_N_S_pwm_leds1_P_compatible_LEN 1
#define DT_N_S_pwm_leds1_P_compatible_EXISTS 1

/*
 * Devicetree node: /pwm_leds1/pwm_led_1
 *
 * Node identifier: DT_N_S_pwm_leds1_S_pwm_led_1
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_pwm_leds1_S_pwm_led_1_PATH "/pwm_leds1/pwm_led_1"

/* Node's name with unit-address: */
#define DT_N_S_pwm_leds1_S_pwm_led_1_FULL_NAME "pwm_led_1"

/* Node parent (/pwm_leds1) identifier: */
#define DT_N_S_pwm_leds1_S_pwm_led_1_PARENT DT_N_S_pwm_leds1

/* Node's index in its parent's list of children: */
#define DT_N_S_pwm_leds1_S_pwm_led_1_CHILD_IDX 0

/* Helper macros for child nodes of this node. */
#define DT_N_S_pwm_leds1_S_pwm_led_1_FOREACH_CHILD(fn) 
#define DT_N_S_pwm_leds1_S_pwm_led_1_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_pwm_leds1_S_pwm_led_1_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_pwm_leds1_S_pwm_led_1_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_pwm_leds1_S_pwm_led_1_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_pwm_leds1_S_pwm_led_1_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_pwm_leds1_S_pwm_led_1_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_pwm_leds1_S_pwm_led_1_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_pwm_leds1_S_pwm_led_1_ORD 40

/* Ordinals for what this node depends on directly: */
#define DT_N_S_pwm_leds1_S_pwm_led_1_REQUIRES_ORDS \
	9, /* /soc/pwm@40050000 */ \
	39, /* /pwm_leds1 */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_pwm_leds1_S_pwm_led_1_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_pwm_leds1_S_pwm_led_1_EXISTS 1
#define DT_N_ALIAS_pwm_led1     DT_N_S_pwm_leds1_S_pwm_led_1
#define DT_N_NODELABEL_pwm_led1 DT_N_S_pwm_leds1_S_pwm_led_1

/* Macros for properties that are special in the specification: */
#define DT_N_S_pwm_leds1_S_pwm_led_1_REG_NUM 0
#define DT_N_S_pwm_leds1_S_pwm_led_1_RANGES_NUM 0
#define DT_N_S_pwm_leds1_S_pwm_led_1_FOREACH_RANGE(fn) 
#define DT_N_S_pwm_leds1_S_pwm_led_1_IRQ_NUM 0
#define DT_N_S_pwm_leds1_S_pwm_led_1_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_pwm_leds1_S_pwm_led_1_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_pwms_IDX_0_EXISTS 1
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_pwms_IDX_0_PH DT_N_S_soc_S_pwm_40050000
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_pwms_IDX_0_VAL_channel 3
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_pwms_IDX_0_VAL_channel_EXISTS 1
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_pwms_IDX_0_VAL_period 20000000
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_pwms_IDX_0_VAL_period_EXISTS 1
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_pwms_IDX_0_VAL_flags 0
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_pwms_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_pwms_FOREACH_PROP_ELEM(fn) fn(DT_N_S_pwm_leds1_S_pwm_led_1, pwms, 0)
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_pwms_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_pwm_leds1_S_pwm_led_1, pwms, 0)
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_pwms_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_pwm_leds1_S_pwm_led_1, pwms, 0, __VA_ARGS__)
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_pwms_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_pwm_leds1_S_pwm_led_1, pwms, 0, __VA_ARGS__)
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_pwms_LEN 1
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_pwms_EXISTS 1
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_label "PWM_LED1"
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_label_STRING_TOKEN PWM_LED1
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_label_STRING_UPPER_TOKEN PWM_LED1
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_label_FOREACH_PROP_ELEM(fn) fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 0) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 1) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 2) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 3) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 4) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 5) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 6) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 7)
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_label_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 0) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 1) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 2) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 3) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 4) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 5) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 6) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 7)
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_label_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 0, __VA_ARGS__) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 1, __VA_ARGS__) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 2, __VA_ARGS__) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 3, __VA_ARGS__) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 4, __VA_ARGS__) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 5, __VA_ARGS__) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 6, __VA_ARGS__) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 7, __VA_ARGS__)
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_label_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 3, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 4, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 5, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 6, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_1, label, 7, __VA_ARGS__)
#define DT_N_S_pwm_leds1_S_pwm_led_1_P_label_EXISTS 1

/*
 * Devicetree node: /pwm_leds1/pwm_led_3
 *
 * Node identifier: DT_N_S_pwm_leds1_S_pwm_led_3
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_pwm_leds1_S_pwm_led_3_PATH "/pwm_leds1/pwm_led_3"

/* Node's name with unit-address: */
#define DT_N_S_pwm_leds1_S_pwm_led_3_FULL_NAME "pwm_led_3"

/* Node parent (/pwm_leds1) identifier: */
#define DT_N_S_pwm_leds1_S_pwm_led_3_PARENT DT_N_S_pwm_leds1

/* Node's index in its parent's list of children: */
#define DT_N_S_pwm_leds1_S_pwm_led_3_CHILD_IDX 1

/* Helper macros for child nodes of this node. */
#define DT_N_S_pwm_leds1_S_pwm_led_3_FOREACH_CHILD(fn) 
#define DT_N_S_pwm_leds1_S_pwm_led_3_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_pwm_leds1_S_pwm_led_3_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_pwm_leds1_S_pwm_led_3_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_pwm_leds1_S_pwm_led_3_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_pwm_leds1_S_pwm_led_3_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_pwm_leds1_S_pwm_led_3_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_pwm_leds1_S_pwm_led_3_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_pwm_leds1_S_pwm_led_3_ORD 41

/* Ordinals for what this node depends on directly: */
#define DT_N_S_pwm_leds1_S_pwm_led_3_REQUIRES_ORDS \
	9, /* /soc/pwm@40050000 */ \
	39, /* /pwm_leds1 */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_pwm_leds1_S_pwm_led_3_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_pwm_leds1_S_pwm_led_3_EXISTS 1
#define DT_N_ALIAS_pwm_led0     DT_N_S_pwm_leds1_S_pwm_led_3
#define DT_N_NODELABEL_pwm_led3 DT_N_S_pwm_leds1_S_pwm_led_3

/* Macros for properties that are special in the specification: */
#define DT_N_S_pwm_leds1_S_pwm_led_3_REG_NUM 0
#define DT_N_S_pwm_leds1_S_pwm_led_3_RANGES_NUM 0
#define DT_N_S_pwm_leds1_S_pwm_led_3_FOREACH_RANGE(fn) 
#define DT_N_S_pwm_leds1_S_pwm_led_3_IRQ_NUM 0
#define DT_N_S_pwm_leds1_S_pwm_led_3_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_pwm_leds1_S_pwm_led_3_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_pwms_IDX_0_EXISTS 1
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_pwms_IDX_0_PH DT_N_S_soc_S_pwm_40050000
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_pwms_IDX_0_VAL_channel 4
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_pwms_IDX_0_VAL_channel_EXISTS 1
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_pwms_IDX_0_VAL_period 20000000
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_pwms_IDX_0_VAL_period_EXISTS 1
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_pwms_IDX_0_VAL_flags 0
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_pwms_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_pwms_FOREACH_PROP_ELEM(fn) fn(DT_N_S_pwm_leds1_S_pwm_led_3, pwms, 0)
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_pwms_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_pwm_leds1_S_pwm_led_3, pwms, 0)
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_pwms_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_pwm_leds1_S_pwm_led_3, pwms, 0, __VA_ARGS__)
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_pwms_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_pwm_leds1_S_pwm_led_3, pwms, 0, __VA_ARGS__)
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_pwms_LEN 1
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_pwms_EXISTS 1
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_label "PWM_LED3"
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_label_STRING_TOKEN PWM_LED3
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_label_STRING_UPPER_TOKEN PWM_LED3
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_label_FOREACH_PROP_ELEM(fn) fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 0) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 1) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 2) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 3) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 4) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 5) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 6) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 7)
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_label_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 0) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 1) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 2) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 3) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 4) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 5) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 6) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 7)
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_label_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 0, __VA_ARGS__) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 1, __VA_ARGS__) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 2, __VA_ARGS__) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 3, __VA_ARGS__) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 4, __VA_ARGS__) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 5, __VA_ARGS__) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 6, __VA_ARGS__) \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 7, __VA_ARGS__)
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_label_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 3, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 4, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 5, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 6, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_pwm_leds1_S_pwm_led_3, label, 7, __VA_ARGS__)
#define DT_N_S_pwm_leds1_S_pwm_led_3_P_label_EXISTS 1
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_pin_controller_40014000_S_adc_default_ORD 42
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_adc_4004c000_ORD 43
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_pin_controller_40014000_S_i2c0_default_ORD 44
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_i2c_40044000_ORD 45
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_pin_controller_40014000_S_i2c1_default_ORD 46
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_i2c_40048000_ORD 47
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_peripheral_clk_ORD 49
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_pin_controller_40014000_S_spi0_default_ORD 50
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_spi_4003c000_ORD 51
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_spi_40040000_ORD 52
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_pin_controller_40014000_S_uart0_default_ORD 54
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_uart_40034000_ORD 55
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_uart_40038000_ORD 56
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_usbd_50100000_ORD 57
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_watchdog_40058000_ORD 59
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_flash_controller_10000000_ORD 60
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_flash_controller_10000000_S_flash_0_ORD 61
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_flash_controller_10000000_S_flash_0_S_partitions_ORD 62
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_flash_controller_10000000_S_flash_0_S_partitions_S_partition_0_ORD 63
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_flash_controller_10000000_S_flash_0_S_partitions_S_partition_100_ORD 64
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_pin_controller_40014000_S_adc_default_S_group1_ORD 65
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_pin_controller_40014000_S_i2c0_default_S_group1_ORD 66
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_pin_controller_40014000_S_i2c1_default_S_group1_ORD 67
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1_ORD 68
...
/* Generic property macros: */
#define DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1_P_pinmux {20 /* 0x14 */, 4 /* 0x4 */, 36 /* 0x24 */, 52 /* 0x34 */}
...
#define DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1_P_pinmux_IDX_2 36
#define DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1_P_pinmux_IDX_2_EXISTS 1
#define DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1_P_pinmux_IDX_3 52
#define DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1_P_pinmux_IDX_3_EXISTS 1
#define DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1_P_pinmux_FOREACH_PROP_ELEM(fn) fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1, pinmux, 0) \
	...
	fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1, pinmux, 2) \
	fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1, pinmux, 3)
#define DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1_P_pinmux_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1, pinmux, 0) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1, pinmux, 1) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1, pinmux, 2) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1, pinmux, 3)
#define DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1_P_pinmux_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1, pinmux, 0, __VA_ARGS__) \
	...
	fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1, pinmux, 2, __VA_ARGS__) \
	fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1, pinmux, 3, __VA_ARGS__)
#define DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1_P_pinmux_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1, pinmux, 0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1, pinmux, 1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1, pinmux, 2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1, pinmux, 3, __VA_ARGS__)
#define DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1_P_pinmux_LEN 4
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch4b_default_ORD 69
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch4b_default_S_group1_ORD 70
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_pin_controller_40014000_S_spi0_default_S_group1_ORD 71
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_pin_controller_40014000_S_spi0_default_S_group2_ORD 72
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_pin_controller_40014000_S_uart0_default_S_group1_ORD 73
...
/* Generic property macros: */
#define DT_N_S_soc_S_pin_controller_40014000_S_uart0_default_S_group1_P_pinmux {194 /* 0xc2 */}
#define DT_N_S_soc_S_pin_controller_40014000_S_uart0_default_S_group1_P_pinmux_IDX_0 194
...
/* Node's dependency ordinal: */
#define DT_N_S_soc_S_pin_controller_40014000_S_uart0_default_S_group2_ORD 74
...
#define DT_FOREACH_HELPER(fn) fn(DT_N) fn(DT_N_S_chosen) fn(DT_N_S_aliases) fn(DT_N_S_soc) fn(DT_N_S_soc_S_interrupt_controller_e000e100) fn(DT_N_S_soc_S_timer_e000e010) fn(DT_N_S_soc_S_memory_20000000) fn(DT_N_S_soc_S_flash_controller_10000000) fn(DT_N_S_soc_S_flash_controller_10000000_S_flash_0) fn(DT_N_S_soc_S_flash_controller_10000000_S_flash_0_S_partitions) fn(DT_N_S_soc_S_flash_controller_10000000_S_flash_0_S_partitions_S_partition_0) fn(DT_N_S_soc_S_flash_controller_10000000_S_flash_0_S_partitions_S_partition_100) fn(DT_N_S_soc_S_peripheral_clk) fn(DT_N_S_soc_S_system_clk) fn(DT_N_S_soc_S_reset_controller_4000c000) fn(DT_N_S_soc_S_pin_controller_40014000) fn(DT_N_S_soc_S_pin_controller_40014000_S_uart0_default) fn(DT_N_S_soc_S_pin_controller_40014000_S_uart0_default_S_group1) fn(DT_N_S_soc_S_pin_controller_40014000_S_uart0_default_S_group2) fn(DT_N_S_soc_S_pin_controller_40014000_S_i2c0_default) fn(DT_N_S_soc_S_pin_controller_40014000_S_i2c0_default_S_group1) fn(DT_N_S_soc_S_pin_controller_40014000_S_i2c1_default) fn(DT_N_S_soc_S_pin_controller_40014000_S_i2c1_default_S_group1) fn(DT_N_S_soc_S_pin_controller_40014000_S_spi0_default) fn(DT_N_S_soc_S_pin_controller_40014000_S_spi0_default_S_group1) fn(DT_N_S_soc_S_pin_controller_40014000_S_spi0_default_S_group2) fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch4b_default) fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch4b_default_S_group1) fn(DT_N_S_soc_S_pin_controller_40014000_S_adc_default) fn(DT_N_S_soc_S_pin_controller_40014000_S_adc_default_S_group1) fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default) fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1) fn(DT_N_S_soc_S_gpio_40014000) fn(DT_N_S_soc_S_uart_40034000) fn(DT_N_S_soc_S_uart_40038000) fn(DT_N_S_soc_S_spi_4003c000) fn(DT_N_S_soc_S_spi_40040000) fn(DT_N_S_soc_S_adc_4004c000) fn(DT_N_S_soc_S_i2c_40044000) fn(DT_N_S_soc_S_i2c_40048000) fn(DT_N_S_soc_S_watchdog_40058000) fn(DT_N_S_soc_S_usbd_50100000) fn(DT_N_S_soc_S_pwm_40050000) fn(DT_N_S_cpus) fn(DT_N_S_cpus_S_cpu_0) fn(DT_N_S_cpus_S_cpu_1) fn(DT_N_S_leds) fn(DT_N_S_leds_S_led_0) fn(DT_N_S_xtal_clk) fn(DT_N_S_pwm_leds) fn(DT_N_S_pwm_leds_S_pwm_led_0) fn(DT_N_S_my_leds_node) fn(DT_N_S_my_leds_node_S_led_blue_node) fn(DT_N_S_my_leds_nodes) fn(DT_N_S_my_leds_nodes_S_led_green_node) fn(DT_N_S_my_leds_nodes1) fn(DT_N_S_my_leds_nodes1_S_led_red_node) fn(DT_N_S_my_leds_nodes2) fn(DT_N_S_my_leds_nodes2_S_led_pink_node) fn(DT_N_S_pwm_leds1) fn(DT_N_S_pwm_leds1_S_pwm_led_1) fn(DT_N_S_pwm_leds1_S_pwm_led_3) fn(DT_N_S_servo1) fn(DT_N_S_servo0) fn(DT_N_S_servo2) fn(DT_N_S_servo3) fn(DT_N_S_my_leds_nodem) fn(DT_N_S_my_leds_nodem_S_echo1) fn(DT_N_S_my_leds_nodem_S_trig1) fn(DT_N_S_my_leds_nodem_S_echo2) fn(DT_N_S_my_leds_nodem_S_trig2) fn(DT_N_S_my_leds_nodem_S_echo3) fn(DT_N_S_my_leds_nodem_S_trig3) fn(DT_N_S_my_leds_nodem_S_echo4) fn(DT_N_S_my_leds_nodem_S_trig4)
#define DT_FOREACH_OKAY_HELPER(fn) fn(DT_N) fn(DT_N_S_chosen) fn(DT_N_S_aliases) fn(DT_N_S_soc) fn(DT_N_S_soc_S_interrupt_controller_e000e100) fn(DT_N_S_soc_S_timer_e000e010) fn(DT_N_S_soc_S_memory_20000000) fn(DT_N_S_soc_S_flash_controller_10000000) fn(DT_N_S_soc_S_flash_controller_10000000_S_flash_0) fn(DT_N_S_soc_S_flash_controller_10000000_S_flash_0_S_partitions) fn(DT_N_S_soc_S_flash_controller_10000000_S_flash_0_S_partitions_S_partition_0) fn(DT_N_S_soc_S_flash_controller_10000000_S_flash_0_S_partitions_S_partition_100) fn(DT_N_S_soc_S_peripheral_clk) fn(DT_N_S_soc_S_system_clk) fn(DT_N_S_soc_S_reset_controller_4000c000) fn(DT_N_S_soc_S_pin_controller_40014000) fn(DT_N_S_soc_S_pin_controller_40014000_S_uart0_default) fn(DT_N_S_soc_S_pin_controller_40014000_S_uart0_default_S_group1) fn(DT_N_S_soc_S_pin_controller_40014000_S_uart0_default_S_group2) fn(DT_N_S_soc_S_pin_controller_40014000_S_i2c0_default) fn(DT_N_S_soc_S_pin_controller_40014000_S_i2c0_default_S_group1) fn(DT_N_S_soc_S_pin_controller_40014000_S_i2c1_default) fn(DT_N_S_soc_S_pin_controller_40014000_S_i2c1_default_S_group1) fn(DT_N_S_soc_S_pin_controller_40014000_S_spi0_default) fn(DT_N_S_soc_S_pin_controller_40014000_S_spi0_default_S_group1) fn(DT_N_S_soc_S_pin_controller_40014000_S_spi0_default_S_group2) fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch4b_default) fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch4b_default_S_group1) fn(DT_N_S_soc_S_pin_controller_40014000_S_adc_default) fn(DT_N_S_soc_S_pin_controller_40014000_S_adc_default_S_group1) fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default) fn(DT_N_S_soc_S_pin_controller_40014000_S_pwm_ch1b_default_S_group1) fn(DT_N_S_soc_S_gpio_40014000) fn(DT_N_S_soc_S_uart_40034000) fn(DT_N_S_soc_S_spi_4003c000) fn(DT_N_S_soc_S_adc_4004c000) fn(DT_N_S_soc_S_i2c_40044000) fn(DT_N_S_soc_S_i2c_40048000) fn(DT_N_S_soc_S_watchdog_40058000) fn(DT_N_S_soc_S_usbd_50100000) fn(DT_N_S_soc_S_pwm_40050000) fn(DT_N_S_cpus) fn(DT_N_S_cpus_S_cpu_0) fn(DT_N_S_cpus_S_cpu_1) fn(DT_N_S_leds) fn(DT_N_S_leds_S_led_0) fn(DT_N_S_xtal_clk) fn(DT_N_S_pwm_leds) fn(DT_N_S_pwm_leds_S_pwm_led_0) fn(DT_N_S_my_leds_node) fn(DT_N_S_my_leds_node_S_led_blue_node) fn(DT_N_S_my_leds_nodes) fn(DT_N_S_my_leds_nodes_S_led_green_node) fn(DT_N_S_my_leds_nodes1) fn(DT_N_S_my_leds_nodes1_S_led_red_node) fn(DT_N_S_my_leds_nodes2) fn(DT_N_S_my_leds_nodes2_S_led_pink_node) fn(DT_N_S_pwm_leds1) fn(DT_N_S_pwm_leds1_S_pwm_led_1) fn(DT_N_S_pwm_leds1_S_pwm_led_3) fn(DT_N_S_servo1) fn(DT_N_S_servo0) fn(DT_N_S_servo2) fn(DT_N_S_servo3) fn(DT_N_S_my_leds_nodem) fn(DT_N_S_my_leds_nodem_S_echo1) fn(DT_N_S_my_leds_nodem_S_trig1) fn(DT_N_S_my_leds_nodem_S_echo2) fn(DT_N_S_my_leds_nodem_S_trig2) fn(DT_N_S_my_leds_nodem_S_echo3) fn(DT_N_S_my_leds_nodem_S_trig3) fn(DT_N_S_my_leds_nodem_S_echo4) fn(DT_N_S_my_leds_nodem_S_trig4)
...
#define DT_N_INST_gpio_leds_NUM_OKAY 6
#define DT_N_INST_pwm_leds_NUM_OKAY 2
#define DT_N_INST_pwm_servo_NUM_OKAY 4
...
#define DT_FOREACH_OKAY_gpio_leds(fn) fn(DT_N_S_leds) fn(DT_N_S_my_leds_node) fn(DT_N_S_my_leds_nodes) fn(DT_N_S_my_leds_nodes1) fn(DT_N_S_my_leds_nodes2) fn(DT_N_S_my_leds_nodem)
#define DT_FOREACH_OKAY_VARGS_gpio_leds(fn, ...) fn(DT_N_S_leds, __VA_ARGS__) fn(DT_N_S_my_leds_node, __VA_ARGS__) fn(DT_N_S_my_leds_nodes, __VA_ARGS__) fn(DT_N_S_my_leds_nodes1, __VA_ARGS__) fn(DT_N_S_my_leds_nodes2, __VA_ARGS__) fn(DT_N_S_my_leds_nodem, __VA_ARGS__)
#define DT_FOREACH_OKAY_INST_gpio_leds(fn) fn(0) fn(1) fn(2) fn(3) fn(4) fn(5)
#define DT_FOREACH_OKAY_INST_VARGS_gpio_leds(fn, ...) fn(0, __VA_ARGS__) fn(1, __VA_ARGS__) fn(2, __VA_ARGS__) fn(3, __VA_ARGS__) fn(4, __VA_ARGS__) fn(5, __VA_ARGS__)
#define DT_FOREACH_OKAY_pwm_leds(fn) fn(DT_N_S_pwm_leds) fn(DT_N_S_pwm_leds1)
#define DT_FOREACH_OKAY_VARGS_pwm_leds(fn, ...) fn(DT_N_S_pwm_leds, __VA_ARGS__) fn(DT_N_S_pwm_leds1, __VA_ARGS__)
...
#define DT_FOREACH_OKAY_pwm_servo(fn) fn(DT_N_S_servo1) fn(DT_N_S_servo0) fn(DT_N_S_servo2) fn(DT_N_S_servo3)
#define DT_FOREACH_OKAY_VARGS_pwm_servo(fn, ...) fn(DT_N_S_servo1, __VA_ARGS__) fn(DT_N_S_servo0, __VA_ARGS__) fn(DT_N_S_servo2, __VA_ARGS__) fn(DT_N_S_servo3, __VA_ARGS__)
#define DT_FOREACH_OKAY_INST_pwm_servo(fn) fn(0) fn(1) fn(2) fn(3)
#define DT_FOREACH_OKAY_INST_VARGS_pwm_servo(fn, ...) fn(0, __VA_ARGS__) fn(1, __VA_ARGS__) fn(2, __VA_ARGS__) fn(3, __VA_ARGS__)
